# Binder
![Binder Logo](/binder_logo.jpg)

*A social network inspired terminal app allowing users to share and/or use unused bin space with other residents in their street.*


## Terminal App built in Ruby
...
## PROBLEM
A local community are seeking an efficient way to dispose of their excess garbage by utilising the total bin space within the community more efficiently.
...
* contact_details
* bin_status
* upcoming_collection_daysA social network inspired terminal app allowing users to share and/or use unused bin space with
other residents in their street.
